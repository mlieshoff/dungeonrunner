 ...
 */
public class GlassHouseStructure extends Structure {

    public GlassHouseStructure(Point3D start) {
        super("GLASSHOUSE", start, new Point3D(start.getX() + 25, start.getY() + 25, start.getZ() + 25));
    }
